function load__light() {
  ...
  if (document.body.style.backgroundColor == "rgb(235, 235, 235)") {
    ...
    document.getElementById("narbar--option").style.backgroundColor =
      "rgb(36, 37, 38)";
    document.getElementById("narbar__option--hide").style.backgroundColor =
      "rgb(36, 37, 38)";
    aElement.style.color = "white";
    document.getElementById("narbar--menu__light").style.backgroundColor =
      "white";
...
narbar__hide__option.addEventListener("click", function () {
  ...
  if (
    narbar__hide__option.classList ==
    "narbar--hide__option narbar--hide--true__option"
  ) {
    narbar__hide__option.classList =
      "narbar--hide__option narbar--hide--false__option";
...
function responsive() {
  ...
  if (width < 369) {
    ...
    narbar__menu.innerHTML = `<div class="narbar--menu">
