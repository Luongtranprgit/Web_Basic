comics = [
  ...
  },
  {
    ...
    intro:
      "Sau khi chạy trốn khỏi ngôi làng bị ma cà rồng phá hủy, cậu bé người sói Joel đã bị ngất và được một phụ nữ tên Adelia đưa về nhà chăm sóc.",
    likes: 20,
    follows: 141,
    views: "16969",
    chapnumber: 27,
  ...
  },
  {
    ...
    intro:
      "Truyện tranh Tôi Viết Sách Để Thăng Cấp được cập nhật nhanh và đầy đủ nhất tại TruyenQQ. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ TruyenQQ ra các chương mới nhất của truyện Tôi Viết Sách Để Thăng Cấp.",
    likes: 1370,
    follows: 5563,
    views: 1747512,
    chapnumber: 131,
